...
if (isset($_POST["email"]) && $_POST["email"] != '') {
  ...
  if ($contador >= 1) {
    ...
    try {
      ...
      <p style="padding: 0; margin: 0;"><span class="mso-font-fix-arial"><span style="font-size:16px;">Tu suscripción se ha realizado con éxito, ya eres parte de </span></span></p>
