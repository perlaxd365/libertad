            ...
            <div class="carousel-item <?=$vFlag;?>">
                ...
                <div class="container">
                    <div class="carousel-caption text-start">
                        <h1><?=$row_["BIB_TITULO"]?></h1>
                        <p><?=$row_["BIB_DESCRIPCION"]?></p>
                        <?php
                        if($row_["BIB_BOTON"] !=="-" and $row_["BIB_BOTON"] !==""){
                        ?>
                        <p><a class="btn btn-lg btn-primary" href="<?=$row_["BIB_LINK"]?>" role="button"><?=$row_["BIB_BOTON"]?></a></p>
                        <?php
                        }
                        ?>
                    </div>
...
<div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">        
    ...
    <div class="col">
        <div class="card shadow-sm">
            <a href="products.php?page=verdetalle&pathId=<?=$row["prod_codigo"]?>" role="button">
                <img src="resources/images/general/<?=VerImage($row["produc_imagen"])?>" width="100%" height="225" role="img">
            </a>
            <div class="card-body">
